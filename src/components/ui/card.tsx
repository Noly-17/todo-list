...
import { DivProps, HeadingProps, ParagraphProps } from "@/lib/component-types"
...
const CardTitle = React.forwardRef<HTMLParagraphElement, HeadingProps>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
